...
const StepProgress = ({ formData, setFormData, propertyImages, setPropertyImages, propertyDataErrors }) => {
    ...
    const displayForm = () => {
        ...
        switch (page) {
            case 0:
                return <Step1 formData={formData} setFormData={setFormData} propertyDataErrors={propertyDataErrors} />;
            case 1:
